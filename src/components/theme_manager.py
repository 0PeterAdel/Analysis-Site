...
class ThemeManager:
    ...
    def create_theme_selector(self):
        ...
        # Add custom styles to ensure text visibility in both light and dark modes
        st.markdown("""
            <style>
                ...
                /* Theme selector dropdown background and text */
        ...
        preview_bg_color = "#FFFFFF" if st.session_state.current_theme == 'light' else "#000000"
        preview_text_color = "#050505" if st.session_state.current_theme == 'light' else "#FFFFFF"
        ...
        ">
            <h4 style="
                ...
                gap: 0.5rem;
            ">
                <span style="font-size: 1.2rem;">{theme_config['icon']}</span>
                <span>{theme_config['name']}</span>
            </h4>
            <div style="
                display: flex;
                gap: 0.5rem;
